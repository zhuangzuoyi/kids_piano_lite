...
#define SAMPLE_DEVICE_NAME          "HaLin"
...
static const uint8_t char_value[20]                 = {'1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j'};

// QueueHandle_t spp_uart_queue = NULL;
QueueHandle_t cmd_cmd_queue = NULL;
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                // esp_log_buffer_hex(GATTS_TABLE_TAG, "1234", 4);
                esp_log_buffer_hex(GATTS_TABLE_TAG, param->write.value, param->write.len);
                xQueueSend(cmd_cmd_queue,param->write.value,10/portTICK_PERIOD_MS);
                // xQueueSend(cmd_cmd_queue,"1234",10/portTICK_PERIOD_MS);
...
void app_main()
{
   ...
   cmd_cmd_queue = xQueueCreate(10, sizeof(uint32_t));
    ...
    xTaskCreate(&blink_task, "blink_task", configMINIMAL_STACK_SIZE *5, NULL, 5, NULL);
}
