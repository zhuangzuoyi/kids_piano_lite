...
public class PlayControlActivity extends AppCompatActivity {
    ...
    public void showConnectedDevice(ConnectEvent event) {
        if (event != null) {
            if (event.isSuccess()) {
                ToastUtil.showToast(PlayControlActivity.this, "Connect Success!");
//                mConnectionState.setText("true");
                ...
                if (event.isDisconnected()) {
                    ToastUtil.showToast(PlayControlActivity.this, "Disconnect!");
                } else {
                    ToastUtil.showToast(PlayControlActivity.this, "Connect Failure!");
                }
